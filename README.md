...
x_{8}(t) &= 2e^{-100t}\sin(2000t)u(t) \tag{7}
...
\sin(2000t) &= \frac{e^{j2000t} - e^{-j2000t}}{2j} \tag{8}
...
X_{8}(\omega) &= \frac{1}{j}(\frac{1}{100 - j(2000 - \omega)} - \frac{1}{100 + j(2000 + \omega)}) \tag{11}
